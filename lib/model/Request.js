...
class Request {
  constructor(req, res) {
    ...
    //   branch: '7e05a60a3f75ad52adab01d800a6fde3b1596a59',
    //   filename: 'README.md',
    //   uri: 'https://github.com/a7medkamel/taskmill-help.git#7e05a60a3f75ad52adab01d800a6fde3b1596a59+README.md',
    //   id: 'fribtn4q65myly5tda4igu1tjzn5qr64'
    // }
    this.doc    = doc;
    this.id     = doc.id;
  ...
  stderr(chunk) {
    ...
    this.decline(err, req, res, { 'try' : true });
  }
  ...
  decline(err, req, res, options = {}) {
    if (!onFinished.isFinished(res) && !res.headersSent) {
