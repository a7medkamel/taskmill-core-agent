    ...
    return super
            ...
            .then((worker) => {
              ...
              let cfg = {
                ...
                'code-module' : config.has('worker.code-module')? config.get('worker.code-module') : 'taskmill-code-dummy'
              }
              ...
              this.docker.run(image, cmd, streams, create_opts, {}, (err, data, container) => {
                ...
                retry(() => Promise
                        ...
                        .then((info) => {
                          ...
                          console.log(info.NetworkSettings.Ports, (diff[0] * 1e9 + diff[1]) / 1e9 );
