...
DockerPool.prototype.get_worker = function() {
  return _.sample(this.workers);
};

DockerPool.prototype.size = function() {
  return _.size(this.workers);
};

DockerPool.prototype.info = function() {
  return _.map(this.workers, function(i){ return _.pick(i, 'id', 'port', 'dir', 'isConnected', 'protocol', 'hostname'); });
};
