...
function handle(data) {
  ...
  // var req = request.get('http://localhost:8989/req/' + data.task.id, { /*forever : false, pool : null*/ });
  // var res = undefined; //request.post('http://localhost:8989/res/' + data.task.id, { /*forever : false, pool : null*/ });
